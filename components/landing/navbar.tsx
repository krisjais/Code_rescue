      ...
      >
        <div className="flex items-center justify-between gap-6">
          ...
          <div className="hidden md:flex items-center gap-2 shrink-0">
            ...
            <a
              href="#hero"
              className="relative px-4 py-1.5 text-sm font-semibold text-white rounded-lg overflow-hidden group transition-all duration-200"
            >
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="flex gap-2 mt-2 pt-2 border-t border-white/5">
              ...
              <a
                href="#hero"
                className="flex-1 flex items-center justify-center px-3 py-2 text-sm font-semibold text-white bg-gradient-to-r from-[#7B61FF] to-[#00D9FF] rounded-lg"
              >
                Get Started
              </a>
            </div>
